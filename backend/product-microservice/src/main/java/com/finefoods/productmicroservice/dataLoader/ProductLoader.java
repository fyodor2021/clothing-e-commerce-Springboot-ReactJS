    ...
    public void run(String... args) throws Exception {
        ...
        if (productRepository.findProductByProductId((long) 2) == null) {
            Product product = Product.builder()
                    ...
                    .category("sweets")
                    .tags("sweets, cookies, rosemary, sticks")
                    .size("400")
                    .unit("g")
                    .cost(10.99)
                    .price(20.00)
...
//                    .category("sweets")
//                    .tags("sweets, cakes, chocolate, white , tuxedo ")
//                    .size("10")
//                    .unit("inches")
//                    .cost(40.00)
//                    .price(50.00)
...
//                    .category("sweets")
//                    .tags("sweets, cakes, strawberry, white , shortcake ")
//                    .size("10")
//                    .unit("inches")
//                    .cost(40.00)
//                    .price(50.00)
...
//                    .category("sweets")
//                    .tags("sweets, cakes, fruits, custard, pastry")
//                    .size("8")
//                    .unit("inches")
//                    .cost(30.00)
//                    .price(40.00)
...
//                    .category("sweets")
//                    .tags("sweets, cakes, chocolate, vanilla")
//                    .size("800")
//                    .unit("g")
//                    .cost(8.00)
//                    .price(11.99)
...
//                    .category("cafe")
//                    .tags("pizza, spicy, cafe, tomato sauce")
//                    .size("100")
//                    .unit("g")
//                    .cost(2.99)
//                    .price(3.99)
...
//                    .category("frozen")
//                    .tags("frozen, pies, mini, cheese, spinach")
//                    .size("18")
//                    .unit("pc")
//                    .cost(7.00)
//                    .price(9.99)
...
//                    .category("grocery")
//                    .tags("grocery, halawa, halva, sesame")
//                    .size("907")
//                    .unit("g")
//                    .cost(3.00)
//                    .price(4.99)
